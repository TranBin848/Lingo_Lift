        ...
        <motion.div variants={cardVariants}>
          <Card className="p-12 text-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-xl">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
              Bạn chưa có khóa học nào. Hãy bắt đầu với bài kiểm tra đầu vào để chúng tôi tạo lộ trình phù hợp cho bạn!
            </p>
          ...
          {courses.length === 0 && (
            <motion.div variants={cardVariants}>
              <Card className="p-12 text-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-xl">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
                  Bắt đầu hành trình chinh phục IELTS bằng cách làm bài kiểm tra đầu vào để chúng tôi tạo lộ trình học phù hợp nhất cho bạn!
                </p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
