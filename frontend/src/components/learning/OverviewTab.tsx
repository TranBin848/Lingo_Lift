      ...
      >
        <Card className="p-12 text-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-xl">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
            {error ? "Chưa có lộ trình học" : "Bắt đầu hành trình của bạn"}
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
            {error ||
              "Bạn chưa có lộ trình học nào. Hãy bắt đầu với bài kiểm tra đầu vào để chúng tôi tạo lộ trình phù hợp nhất cho bạn!"}
          </p>
