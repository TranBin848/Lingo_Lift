/**
 * Task 2 Topic List Component
 * 
 * Displays a list of Task 2 topics with loading and error states
 * Uses the useTask2Topics hook for data fetching
 */
 ...
 * Task 2 Topic List Component
 */
export default function Task2TopicList() {
  const [taskType, setTaskType] = useState<Task2Type>('Academic');
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-4 mb-4">
          <div>
            ...
            <select
              value={taskType}
              onChange={(e) => setTaskType(e.target.value as Task2Type)}
          ...
          {topics.map((topic) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <button
                  className="ml-4 px-4 py-2 bg-purple-600 text-white text-sm rounded-lg hover:bg-purple-700 transition-colors whitespace-nowrap"
