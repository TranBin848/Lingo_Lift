      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> IELTS</span>
          </motion.h1>
          ...
          >
            Bài kiểm tra này giúp AI đánh giá chính xác trình độ Writing hiện tại của bạn, 
            từ đó xây dựng lộ trình học cá nhân hóa phù hợp nhất.
          </motion.p>
        </div>
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              <Card className="p-5 text-center bg-white dark:bg-gray-800 border-0 shadow-lg hover:shadow-xl transition-shadow">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${feature.color} shadow-md mb-3`}>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Viết ít nhất 150 từ mô tả và phân tích thông tin từ biểu đồ hoặc hình ảnh.
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl bg-purple-50 dark:bg-purple-900/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Viết ít nhất 250 từ trình bày quan điểm về một chủ đề.
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-violet-100 to-purple-100 dark:from-violet-900/40 dark:to-purple-900/40 mb-6">
